      ...
      <div class='caja'>
        ...
        <div class="texto1">
          <div id='penitenciariatexto'>
            <MyCard startCount={count} firstText={"69274"} secondText={"Internos"} statusImage={AssignmentIndIcon} />
          </div>
        </div>

        <div class="texto2">
          <div id='penitenciariatexto'>
            <MyCard startCount={count} firstText={"2826"} secondText={"Teléfonos Públicos"} statusImage={PhoneIcon} />
          </div>
        </div>
